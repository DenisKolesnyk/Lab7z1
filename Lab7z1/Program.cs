        ...
        public static void AddPassenger()
        {
            ...
            if (passengers == names.Length)
            {
                try
                {
                    ...
                    {
                        throw new KilkistException($"ПОМИЛКА: Не поміститься стільки пасажирів");
                    }
                    else
                    {
                        Statistic.CurPass++;
                        ...
                        Console.WriteLine("Пасажири  додані на рейс:> " + Statistic.CurPass + " | " + maxPassengers);
                    }
                }
                catch (Exception ex)
                {
            ...
            {
                Console.WriteLine("ПОМИЛКА: Не всі імена  вказані: " + names.Length + " | " + passengers);
            }
            else if (passengers < names.Length)
            {
